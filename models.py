...
def create_tables():
    with database:
        database.create_tables([Artists, Albums, PlaylistTrack, InvoiceItems, Invoices, Playlists, Customers])


def drop_tables():
    with database:
        database.drop_tables([Artists, Albums, PlaylistTrack, InvoiceItems, Invoices, Playlists, Customers])